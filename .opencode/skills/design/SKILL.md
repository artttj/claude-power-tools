---
name: design
description: Enforces precise, minimal design for dashboards and admin interfaces. Use when building SaaS UIs, data-heavy interfaces, or any product needing pixel-level discipline.
---
...
Detect which styling approach the project uses, then apply the appropriate patterns:

- **CSS Modules / Vanilla CSS / styled-components**: Use semantic class names, CSS custom properties for theming, BEM-style naming for components
- **Tailwind CSS**: Use utility classes with component composition patterns, @apply for reusable component styles
- **CSS-in-JS (Emotion, styled-components)**: Use component-based styling with theme support
- **No framework (vanilla)**: Use CSS custom properties for design tokens, semantic HTML, progressive enhancement

Match your implementation approach to the project's existing patterns and conventions.
