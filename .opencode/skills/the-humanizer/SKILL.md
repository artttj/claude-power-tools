...
name: the-humanizer
description: >-
  Self-educating humanizer skill that keeps up with the latest LinkedIn AI slop patterns.
  Auto-detects channel, scores the original, returns a humanized rewrite
  with the patterns it fixed listed. TRIGGER on "humanize", "sounds like
  AI", "AI detection", "make it sound human", "rewrite in my voice",
  "voice check", "blog review", "LinkedIn post review", "email review",
  "does this sound like AI" — even without naming the skill.
---
...
- Hollow intensifiers: "crucial", "essential", "incredibly", "significantly", "pivotal" (especially "pivotal role"/"pivotal moment"), "enduring" (especially "enduring legacy")
- AI vocabulary: "delve", "leverage" (as verb), "transformative", "game-changing", "seamless", "robust", "synergy", "best practices", "thought leader", "landscape", "paradigm", "harness", "navigate", "unlock", "empower", "streamline", "holistic", "tapestry", "multifaceted", "nuanced", "foster", "cultivate", "facilitate", "utilize", "comprehensive", "albeit", "whilst", "theater", "plainly", "superpower", "journey", "reality" (as dramatic reveal), "elevate", "realm", "essentially", "certainly", "intricate", "underscore" (and "underscores"), "vibrant", "groundbreaking", "showcasing", "garner", "meticulous", "surpass"
...
- Promotional verb upgrades: "stands as", "serves as", "features" (as a verb meaning "has"), "boasts", "maintains". AI replaces plain "is/has" with these verbs to inflate significance, e.g. "The library serves as a bridge between X and Y" instead of "The library connects X and Y." Use the simpler verb that actually describes the action.
- Vague unsourced attribution: "Industry reports indicate", "Observers have cited", "Experts argue", "Some critics argue", "Due to its unique characteristics", "Efforts are ongoing to". AI uses these to launder unsupported claims as conventional wisdom. Either name a real source or cut the appeal-to-authority framing.
...
- Avoidance of plain "is/are": replacing "X is Y" with "X serves as Y", "X stands as Y", "X features Y", or "X boasts Y" across multiple sentences. The dressed-up verbs add no information. Rewrite with the simpler form.
- Present-participle attachments for shallow analysis: tacking "...highlighting their significance", "...emphasizing the importance", "...underscoring the role" onto the end of a clause to feign analysis without adding a real claim. Cut the participle or replace with a clause that actually says what happens.
- Challenges-then-future framework: "Despite X's success, several challenges remain. However, ongoing efforts suggest..." This is a content-mill template that gestures at problems without naming them and at progress without describing it. Name the actual challenges and what's actually being done.
- Title-Cased Headers: capitalizing every main word in a section heading (e.g. "Impact Of Technology And Digitalization"). This is an AI default lifted from old web style. Use sentence case unless the project's house style requires otherwise.
...
Overused transitions, hollow intensifiers, AI vocabulary (43+ words), AI phrasing & metaphors (16+ phrases), promotional verb upgrades, vague unsourced attribution, stacked abstract noun lists, passive voice, hedge phrases, filler openers, product-tagline phrasing, runway sentences

**Structural AI markers (universal):**
Generic openings, bullet-point overuse, template structures, summary closings, uniform paragraph length, stacked fragments, negation constructions, honesty disclaimers, credential stacking, definition reframes, punchy orphan closers, tension-colon openers, stat bomb openers, self-posed questions, declarative reveals, label-colon frameworks, triple rhetorical questions, adverb-stacking pivots, standalone hype fragments, mirrored instruction pairs, avoidance of plain "is/are", present-participle attachments, challenges-then-future framework, Title-Cased Headers
