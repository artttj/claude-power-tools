...
<div class="p-4">
  <div class="px-4 py-3">
    <!-- Only when horizontal needs more room -->

    <!-- Bad: asymmetric noise -->
    <div class="pt-6 pr-4 pb-3 pl-4"></div>
  </div>
</div>
```
...
```html
<div class="border border-black/[0.08] rounded-lg"></div>
```
  ...
  <h2 class="text-lg font-semibold tracking-tight">
    ...
    <p class="text-sm text-fg-secondary">
      ...
      <span class="text-xs font-medium uppercase tracking-wide text-fg-muted">
        <!-- Data -->
        <span class="font-mono text-sm tabular-nums"></span
      ></span>
    </p>
  </h2>
</h1>
...
<div class="border border-black/[0.08] dark:border-white/[0.1]">
  <div
    class="bg-surface dark:bg-surface shadow-subtle dark:shadow-none dark:border dark:border-white/[0.06]"
  ></div>
</div>
```
